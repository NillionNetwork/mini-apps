...
export default function AppTable({ apps, selectedAppId, onSelectApp }: AppTableProps) {
  return (
          ...
          {apps.length === 0 ? (
            ...
            apps.map((app, index) => (
              ...
              >
                ...
                <div className="col-span-3 p-2 border-r border-gray-800 truncate">{app.category}</div>
                <div className="col-span-2 p-2 border-r border-gray-800">
                  {app.demoUrl ? 'Available' : 'N/A'}
                </div>
                <div className="col-span-2 p-2">
                  {app.githubUrl ? 'Available' : 'N/A'}
                </div>
              </div>
            ))
          )}
